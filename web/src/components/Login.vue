  ...
  <v-container>
    <v-card flat>
      <v-card-title>
        ...
        <v-card-title> Flip - 人力資源管理系統 </v-card-title>
      </v-card-title>
    </v-card>
    <v-card outlined rounded>
      <v-card-title> 登入 </v-card-title>
      <v-card-subtitle> 歡迎使用 </v-card-subtitle>
      <v-card-subtitle
      ...
      <v-card-actions v-if="!id_login">
        <v-btn :disabled="true" depressed> 單一簽入認證 </v-btn>
        <v-spacer />
      ...
      <div v-else>
        ...
        <v-card-actions>
          <v-btn :disabled="loading" @click="id_login = false" depressed
            >取消</v-btn
          >
          <v-spacer />
          <v-btn :loading="loading" @click="submit" class="secondary" depressed
            >登入</v-btn
          >
        </v-card-actions>
      </div>
